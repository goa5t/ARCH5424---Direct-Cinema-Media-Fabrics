//April 9, 2017, edited Nov. 11 2017
//Guthrie Alexander
...
void draw(){
  //if we reach the end of text file, loop back to beginning
  if(idx > lines.length-1)
    idx = 0;
    
  /*
  Grab the Sensor Data from text file
  */
  ...
  //parse text value of photosensor value, store it in n
  ...
  //parse text value of sound sensor value, store value in s
...
void drawEyes(int phase, float sound){
  int eyeSize = 8;
  //if sound exists and it's night time
